...
<!-- <div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="<?php echo base_url() ?>index.php/Welcome">Furniture<span> Shop</span></a></h1>
                </div>
            </div> -->
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php
                        if(isset($_SESSION['email']) == ''){
                            ?>
                            <li><a href="<?php echo base_url() ?>index.php/Welcome/login" style="margin-left: 700px;"><i class="fa fa-user"></i> Login Or Register</a></li>
                            <?php
                        }
                        ?>
                        <!--<li><a href="#"><i class="fa fa-heart"></i> Wishlist</a></li>-->
                        <?php
                            if(isset($_SESSION['email'])){
                                if(!$_SESSION['email'] == ''){
                                    ?>
                                    <li><a href="<?php echo base_url() ?>index.php/Cart/viewCart"><i class="fa fa-shopping-cart"></i> My Cart</a></li>
                                    <li><a href="<?php echo base_url() ?>index.php/Welcome/user_ord"></i>My Orders</a></li>
                                    <li><a href="<?php echo base_url() ?>index.php/Welcome/profile"><i class="fa fa-user"></i> Profile</a></li>
                                    <?php
